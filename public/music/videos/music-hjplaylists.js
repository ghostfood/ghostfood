function getPlaylist() {
    ...
    if (23 <= now && now < 24) {
        if (30 <= min && min < 59) {
            ...
            document.getElementById('player').src = '//app.viloud.tv/player/embed/channel/77b4e2854e0f8c13806d3ba2df94af2b?autoplay=1&volume=0&controls=1&title=1&share=0&random=1';
            document.getElementById("playlist-info").innerHTML = '<div class="align-left width-100-then-50"><h5>Scheduled from 11.30 - Midnight </h5> Music Videos 2020 <br/><span class="small">(Almost anything goes in this selection of music videos from this year)</span><br/><a href="https://www.youtube.com/playlist?list=PLHvKxcWzqg0c5yRVYaeYNiy_NLI_pJ0NS" class="cta">View on YouTube</a></div><div class="align-left width-100-then-50"><h5>Refresh from Midnight for</h5> Haunted Jukebox Dark </div>';
        } // closes 2330-0000
    }
